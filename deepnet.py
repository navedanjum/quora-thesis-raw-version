...
for line in tqdm(f):
    ...
    word = values[0]
    #print(values[1:])
    #values[1:] = [x.replace('.', '0') for x in values[1:]]
    #values[1:] = [x.replace('name@domain0com', '0') for x in values[1:]]
    #values[1:] = [x.replace('Killerseats0com', '0') for x in values[1:]]
    #values[1:] = [x.replace ('mylot0com', '0') for x in values[1:]]
    try:
...
##merged_model.add(merge([model1, model2, model3, model4, model5, model6], mode='concat'))
#merged_model.add(Concatenate([model1, model2, model3, model4, model5, model6]))
